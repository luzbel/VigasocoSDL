...
//#ifndef __abadIA_REPLAY__
	...
	// TODO: �reiniciar en cada reset o load? 
...
#ifdef __abadIA__
			// Ya hemos hecho todo lo que ten�amos que hacer
			// av�semos a la IA
//fprintf(stderr,"AAA\n"); 
...
bool Juego::muestraPantallaFinInvestigacion()
{
	...
	// tenga la �ltima foto con haFracasado=true
	//save(0); 
	// No es grabar, es un dump lo que necesita la IA
	if(!infoJuego->dumpInfo(true))
		fprintf(stderr,"Error volcando info en pantalla fin de investigaci�n\n"); 
#endif
...
//fprintf(stderr,"espera %d\n",espera);
	...
	// El bucle anterior espera a que se est� �pulsando espacio
