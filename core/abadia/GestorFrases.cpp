...
/////////////////////////////////////////////////////////////////////////////
	...
	" ", // 0 	Limpiar el area de frases al cargar/salvar una partida
	"¿QUE EXTRAÑO LUGAR ES ESTE Y COMO HEMOS LLEGADO AQUI? ¿QUE ES ESTE TERRIBLE SILENCIO?", // 1
	"ALGO NOS HA TRAIDO, ESTOY SEGURO PICKMAN, PERO ¿EL QUE?", // 2
	"NO LO SE, HARLEY. LO AVERIGUAREMOS. ESTA NOCHE PARECE ETERNA", // 3
	"ACABA DE AMANECER Y EL SOL PARECE MORIBUNDO. UN FRÍO ATROZ AZOTA LA LLANURA ALLÍ FUERA." , // 4
	"ESA SOMBRA SIGÁMOSLA", // 5 TODO: añadir caracter para abrir y cerrar admiracion "¡ESA SOMBRA! ¡SIGÁMOSLA!"
	"AHORA NO PODÉIS INVOCARME. BAJO LA LUNA DEL TERCER DÍA, VOLVED, Y MIRADME CON OTROS OJOS.", // 6 
	"LA CEREMONIA VA A COMENZAR. SALID DE AQUÍ", // 7 TODO: falta ¡y!
	"SEGUIDME", // 8 
	"HEI AA-SHANTA 'NYGH ERES LIBRE DEVUELVE LOS DIOSES TERRESTRES A LA MORADA QUE POSEEN EN LA IGNORADA KADATH, Y ROGAD A TODO EL ESPACIO PARA QUE JAMÁS LLEGUÉIS A VERME EN NINGUNA DE MIS OTRAS MIL ENCARNACIONES." , // 9 TODO: faltan admiraciones
	"IÄ IÄ HEI AA-SHANTA 'NYGH" , // 0xa TODO: faltan admiraciones
	"DEBE SER LA CELDA DEL SUMO SACERDOTE." , // 0xb
	"LA TABLILLA ESTÁ ESCRITA EN ESA EXTRAÑA LENGUA. NO CONSIGO DESCIFRARLA.", // 0xc
	"DEBEMOS VOLVER A ESE ALTAR SI NO QUEREMOS LEVANTAR SOSPECHAS.", // 0xd
	"UNA EXTRAÑA PRESENCIA SE ENTROMETE EN NUESTRO MUNDO. DADLE CAZA" , // 0xe TODO: faltan admiraciones
	"IÄ IÄ" , // 0xf TODO: faltan admiraciones
	"SIN LA BENDICIÓN DEL SC NO PODÉIS PASAR MARCHAOS",  // 0x10 TODO: faltan admiraciones
	"¿QUÉ HA SIDO ESTO? ¿DÓNDE ESTAMOS?" , // 0x11
	"ESA SOMBRA NOS DARÁ LA RESPUESTA." , // 0x12
	"PICKMAN, FÍJATE EN ESAS EXTRAÑAS HUELLAS." , // 0x12+1
	"COMO EL RASTRO DE MIL SERPIENTES.",  // 0x14
	"ESTÁ DEMASIADO OSCURO. NO VEREMOS NADA SIN UNA LÁMPARA." // 0x15
#else
